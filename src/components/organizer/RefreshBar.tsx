  ...
  return (
    <div className="flex shrink-0 items-center gap-3">
      ...
      <button
        ...
        className="shrink-0 whitespace-nowrap rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-xs font-medium text-neutral-200 active:scale-95 disabled:opacity-50"
      >
        {busy ? "更新中..." : "更新"}
      </button>
    </div>
