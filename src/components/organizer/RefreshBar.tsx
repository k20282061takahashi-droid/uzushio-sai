  ...
  return (
    <div className="flex shrink-0 items-center gap-3">
      <div className="text-right leading-tight">
        <p className="hidden text-[13px] text-neutral-400 sm:block">最終更新</p>
        <p className="font-mono text-xs text-neutral-300">
          {formatClock(lastUpdated)}
          {agoText && (
            <span className="ml-1 hidden text-neutral-400 sm:inline">
              ({agoText})
            </span>
          )}
        </p>
      ...
      <button
        ...
        className="shrink-0 whitespace-nowrap rounded-lg border border-white/10 bg-neutral-950/72 px-3 py-2 text-xs font-medium text-neutral-200 active:scale-95 disabled:opacity-50"
      >
        {busy ? "更新中..." : "更新"}
      </button>
    </div>
